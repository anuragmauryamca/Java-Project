...
<html>
    ...
    <body>
        ...
        <table border="1" align="center" width="90%" style="border-collapse: collapse">
            ...
            <tr><td height="20">
                    <jsp:include page="menu_dashboard.jsp"/></td></tr>
            <tr><td height="3" >
                    ...
                    <a href="<c:url value="user_list.jsp"/>"> 
                       
                       
                </td></tr> 
                    <tr><td height="200"  align="center">
                        
                            <div style="color:darkred;margin-left: 500;font-size: 18px;background-color: cadetblue;border-radius: 105px;padding: 10px">
                                <a href="user_list.jsp">User List</a></div>
